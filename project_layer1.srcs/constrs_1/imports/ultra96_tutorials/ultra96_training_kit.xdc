...
set_property PACKAGE_PIN G6 [get_ports start]
set_property PACKAGE_PIN E6 [get_ports rst]
#set_property PACKAGE_PIN E5   [get_ports {RXD              }];  # "E5.HD_GPIO_10"
...
create_clock -period 25.000 -name clk40hz -waveform {0.000 12.500}
